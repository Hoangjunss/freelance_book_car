...
import { SupplierServiceService } from '../../../../services/AdminSupplier/supplier/supplier-service.service';
import { User } from '../../../../models/AdminSupplier/response/user/user';
import { UserService } from '../../../../services/AdminSupplier/user/user.service';
...
createTourRequest: any = {
  ...
  updateTourRequest: Supplier = new Supplier();
  ...
  constructor(private tourService:UserService){}
  ...
  displayFromUpdate(tour: Product){
   /*  this.updateTourRequest =  {
      ...
      officialPriceDTO: tour.officialPriceDTO, 
      productStatusActivity: tour.productStatusActivity, 
      productStatusVerify: tour.productStatusVerify 
    }
...
/*     console.log(this.updateTourRequest);
  ...
  getAllTour(page:number){
    this.tourService.getUser(page).subscribe({
      next: (data) => {
